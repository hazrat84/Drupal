...
/**
 * @file
 * Contains \Drupal\timeslots\Form\TimeslotDeleteForm.
 */
 ...
 * @ingroup timeslots
 */
class TimeslotDeleteForm extends ContentEntityConfirmFormBase {
  ...
  public function submitForm(array &$form, FormStateInterface $form_state) {
    ...
    $this->logger('timeslots')->notice('deleted %title.',
      array(
